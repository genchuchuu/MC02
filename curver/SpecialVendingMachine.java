...
class SpecialVendingMachine extends VendingMachine {
    ...
    public String prepareDrink(CustomDrink customDrink) {
        StringBuilder message = new StringBuilder();
        
        message.append("\n\nPreparing the drink: ").append(customDrink.getDrinkName());
        message.append("\nCustomizations:");
        message.append("\nCup Size: ").append(customDrink.getCupSize());
        message.append("\nTemperature: ").append(customDrink.getTemperature());
        message.append("\nWith: ").append(customDrink.getSugarLevel());
        message.append("\nMilk Choice: ").append(customDrink.getMilkChoice());
        message.append("\nEspresso Shots (Hot): ").append(customDrink.getNumEspressoShots());
        message.append("\nEspresso Shots (Iced): ").append(customDrink.getNumEspressoShots());
        message.append("\n\nMixing the drink...");
        message.append("\n\nPouring the drink to cup ").append(customDrink.getCupSize());
    ...
    private void confirmOrder(Scanner scanner, CustomDrink customDrink, int totalCalories, double totalPrice, double amountPaid) {
        ...
        System.out.println("Espresso Shots: " + customDrink.getNumEspressoShots());
